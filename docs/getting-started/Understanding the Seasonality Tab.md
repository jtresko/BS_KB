...
![](/assets/images/help/getting-started/Understanding the Se_March+SPY+-+Seasonality.png)

# **What Does the Seasonality Tab Show?**

  1. **Calendar Date Performance** :
  ...
  2. **Day of the Week Performance** :
     ...
     * Metrics include:
       ...
       * **Average Return** : How SPY has historically performed on each day of the week.
...
# **How to Use the Seasonality Tab**
  ...
  2. **Adding Context to Your Trades** :
