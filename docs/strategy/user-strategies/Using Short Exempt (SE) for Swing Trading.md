...
Today we're going to learn about how to trade using the [Short Exempt](/indicators-and-features/What is Short Exempt (SE)/) indicators on BigShort. For swing traders in particular, this signal can mean the difference between financial independence or leaving your day job, and fighting for profitability.  
  
This trade starts on the [Dashboard tab](/getting-started/platform-tabs/Dashboard & Top 10s/) in BigShort (yellow box, below). Look for Top 10 SE (blue box, below):
...
![](/assets/images/help/strategy/Using Short Exempt (_TOP+10+SE+Date.png)
...
![](/assets/images/help/strategy/Using Short Exempt (_SE+SOUN.png)
...
![](/assets/images/help/strategy/Using Short Exempt (_SOUN+chart.png)
...
If you're a swing trader, consider using Short Exempt (SE) via this Dashboard tab > Short Volume tab > SF Segregated tab to find, assess, and trade some of the biggest movers in the market. Be sure to join the [members-only Discord](/discord-community/How to Join our Members-Only Discord Channels/) and watch the #swing-trading channel for trade ideas!  
