---
title: "Tae's Corner: SPY - Nov 20, 2024"
layout: default
parent: Tae's Corner
nav_order: 3
...
In Tae's corner, we share small snapshots of advice and wisdom from BigShort's founder, Tae, that he often shares in the Tutoring channel of our [Discord community.](/discord-community/How to Join our Members-Only Discord Channels/)
...
## **Midday Short**
  ...
  * Bearish [Dark Pools](/indicators-and-features/Understanding Dark Pools and DarkFlow in BigShort/) (DPs) had been appearing throughout the morning. Remember, when DPs appear above the public price, they usually act as resistance and often push the price down (bearish)

  * Net Option Flow Accumulation ([NOFA](/indicators-and-features/Net Option Flow A Complete Guide/)) had also been steadily decreasing all morning (bearish).
